...
export default function Home() {
  ...
  // FIXED: Changed the shortcut @/lib/i18n to a relative path
      ...
      <section className="relative text-white py-24 overflow-hidden min-h-[80vh] flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center w-full">
          ...
          <button
            ...
            className="bg-white text-blue-700 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-100 transition shadow-lg hover:shadow-xl transform hover:scale-105"
          >
            {t('chooseCareer')}
          </button>
        </div>
